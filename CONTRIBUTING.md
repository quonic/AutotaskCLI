# Contributing to AutotaskCLI

We welcome and appreciate contributions from all walks of life.
There are many ways to become involved with AutotaskCLI:
...
* Get familiar with the [AutotaskCLI repository](../docs/git).
...
* If you can't find your issue already,
  [open a new issue](https://github.com/AutotaskCLI/AutotaskCLI/issues/new),
  making sure to follow the directions as best you can.
* If the issue is marked as [`Up-for-Grabs`][up-for-grabs],
  the AutotaskCLI Maintainers are looking for help with the issue.

## Contributing to Documentation

### Contributing to documentation related to AutotaskCLI

Please see the [Contributor Guide in `AutotaskCLI/AutotaskCLI-Docs`](https://github.com/AutotaskCLI/AutotaskCLI-Docs/blob/staging/CONTRIBUTING.md).

### Contributing to documentation related to maintaining or contributing to the AutotaskCLI project
...
#### Building AutotaskCLI

Please see [Building AutotaskCLI](../README.md#building-the-repository).

#### Testing AutotaskCLI

Please see AutotaskCLI [Testing Guidelines - Running Tests Outside of CI][running-tests-outside-of-ci] on how to test you build locally.
...
1. Mention in the issue that you are working on the issue and ask `@AutotaskCLI/AutotaskCLI` for an assignment.
...
* If you're contributing in a way that changes the user or developer experience, you are expected to document those changes.
  See [Contributing to documentation related to AutotaskCLI](#contributing-to-documentation-related-to-AutotaskCLI).
...
* If your change warrants an update to user-facing documentation,
  a Maintainer will add the `Documentation Needed` label to your PR and add an issue to the [AutotaskCLI-Docs repository][AutotaskCLI-Docs],
  ...
  (See [Contributing to documentation related to AutotaskCLI](#contributing-to-documentation-related-to-AutotaskCLI) for more info.)
...
1. *Assignee* who are always *Maintainers* ensure that proper review has occurred and if they believe one approval is not sufficient, the *maintainer* is responsible to add more reviewers.
   ...
   For more information on the AutotaskCLI Maintainers' process, see the [documentation](../docs/maintainers).
...
For example, changing AutotaskCLI parameters, APIs, or protocols break the public contract.
Before making changes to the code,
first review the [breaking changes contract](../docs/dev-process/breaking-change-contract.md)
and follow the guidelines to keep AutotaskCLI backward compatible.

## Making Design Changes

To add new features such as cmdlets or making design changes,
please follow the [AutotaskCLI Request for Comments (RFC)](https://github.com/AutotaskCLI/AutotaskCLI-RFC) process.

## Common Engineering Practices

Other than the guidelines for ([coding](../docs/dev-process/coding-guidelines.md),
the [RFC process](https://github.com/AutotaskCLI/AutotaskCLI-RFC) for design,
...
* Don't commit code that you didn't write.
  If you find code that you think is a good fit to add to AutotaskCLI,
...
[open-issue]: https://github.com/AutotaskCLI/AutotaskCLI/issues
[up-for-grabs]: https://github.com/AutotaskCLI/AutotaskCLI/issues?q=is%3Aopen+is%3Aissue+label%3AUp-for-Grabs
[semantic linefeeds]: http://rhodesmill.org/brandon/2012/one-sentence-per-line/
[AutotaskCLI-Docs]: https://github.com/AutotaskCLI/AutotaskCLI-docs/
[use-vscode-editor]: ../docs/learning-AutotaskCLI/using-vscode.md#editing-with-visual-studio-code
